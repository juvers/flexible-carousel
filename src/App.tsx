...
const App = () => {
  ...
  const [indexer, getIndexer] = React.useState(0);
  return (
    <>
      <Carousel
        interval={2000}
      ...
      >
        {colors.map((item, i) => (
          <div
            ...
            style={{
              width: "100%",
              height: i === indexer ? "60vh" : "40vh",
              backgroundColor: colors[i],
            }}
          ></div>
        ))}
      </Carousel>
      <h1>What is indexer: {indexer}</h1>
      ...
      {/* <motion.div
        ...
        drag="x"
        dragConstraints={{ left: -10, right: 150 }}
      />
      <motion.div
        style={{ height: "300px", width: "300px", background: "#f00" }}
        animate={{ x: 100 }}
      /> */}
      {/* <motion.div
        style={s1}
